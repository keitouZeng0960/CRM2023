...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						姓名：<b>${sessionScope.systemUser.name}</b><br><br>
						登录帐号：<b>${sessionScope.systemUser.loginAct}</b><br><br>
						组织机构：<b>${sessionScope.systemUser.deptno}</b><br><br>
						邮箱：<b>${sessionScope.systemUser.email}</b><br><br>
						失效时间：<b>${sessionScope.systemUser.expireTime}</b><br><br>
						允许访问IP：<b>${sessionScope.systemUser.allowIps}</b>
					</div>
				</div>
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='settings/qx/user/login.jsp';">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2019&nbsp;动力节点</span></div>
